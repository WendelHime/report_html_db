use utf8;
package html_dir::Chado::Result::NdExperimentPub;
...
html_dir::Chado::Result::NdExperimentPub - Linking nd_experiment(s) to publication(s)
...
=head1 TABLE: C<nd_experiment_pub>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:TmlloWH5ZIeOJfuDCwlniA
