use utf8;
package HTML_DIR::Chado::Result::NdExperimentDbxref;
...
HTML_DIR::Chado::Result::NdExperimentDbxref - Cross-reference experiment to accessions, images, etc
...
=head1 TABLE: C<nd_experiment_dbxref>
...
=item * L</nd_experiment_dbxref_id>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:M7i6ojcaIvjMMPgurEDWgw
