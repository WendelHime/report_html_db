use utf8;
package HTML_DIR::Chado::Result::Libraryprop;
...
HTML_DIR::Chado::Result::Libraryprop - Tag-value properties - follows standard chado model.
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:N7EjADiqIXZlHAd5WGjiGA
