use utf8;
package HTML_DIR::Chado::Result::LibrarypropPub;
...
HTML_DIR::Chado::Result::LibrarypropPub - Attribution for libraryprop.
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:pXRmufR41zq8FPiRCj+d+g
