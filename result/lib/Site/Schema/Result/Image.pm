use utf8;
package Site::Schema::Result::Image;
...
Related object: L<Site::Schema::Result::RelationsTextsImage>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:tLpCGfQYL8om7gf93EoPzA
